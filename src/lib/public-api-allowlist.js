...
const PUBLIC_ROUTES = new Map([
  ...
  ['/api/radar/scout', { params: ['recipe', 'brokerSessions', 'consolidationSessions', 'supportSessions', 'maxPrice', 'minAverageValue', 'limit', 'useBroker', 'useSupport', 'useSideways', 'useMaxPrice', 'useLiquidity'] }],
